...
((SCRIPT++))
eval pybatch.py --script ~/python/batch_tool/samples/test_script.py --infiles b1/1 b1/2 b2/3 b3/4 b4/5 b4/6 b5/7 b5/8 b5/9 b5/10  --verbose --dry-run ${OUT} || echo "script ${SCRIPT} failed: $((CNT++))"
...
((SCRIPT++))
eval pybatch.py --no-shadow --script ~/python/batch_tool/samples/test_script.py --infiles 1 --parameter thres=0.75 -p result=result.nii.gz ${OUT} || echo "script ${SCRIPT} failed: $((CNT++))"
